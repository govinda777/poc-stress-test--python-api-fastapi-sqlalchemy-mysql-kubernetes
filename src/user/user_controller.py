...
class UserController:
    def __init__(self):
        ...
        self.service = UserService()  # Aqui você pode inicializar o serviço. Se estiver usando injeção de dependência, pode ajustar isso.
    ...
    @self.router.put("/users/{user_id}", response_model=User)
    def update_user(self, user_id: int, user: User):
        return self.service.update_user(user_id, user)

    @self.router.delete("/users/{user_id}", response_model=User)
